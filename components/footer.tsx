...
export default function Footer() {
  ...
  return (
    <footer className="bg-linear-to-br from-primary to-primary/90 text-primary-foreground pt-20 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <h4 className="font-bold text-lg mb-6 text-primary-foreground">
              Quick Links
            </h4>
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                ...
                >
                  <Link
                    href={link.href}
                    className="text-primary-foreground/80 hover:text-primary-foreground text-sm transition-colors duration-300 flex items-center gap-2 group"
                  >
                    <div className="w-1.5 h-1.5 bg-primary-foreground/30 rounded-full group-hover:bg-accent transition-colors duration-300" />
                    {link.name}
                  </Link>
                </motion.li>
              ))}
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="mt-6 p-4 bg-primary-foreground/5 rounded-xl border border-primary-foreground/10">
              <h5 className="font-semibold text-sm mb-2 text-primary-foreground">
                Service Times
              </h5>
        ...
        {/* Bottom Bar */}
        <motion.div
          className="border-t border-primary-foreground/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-primary-foreground/70"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
        >
          <p>&copy; 2025 The Apostolic Church Canada. All rights reserved.</p>
